...
VALUES
    ...
    ('jane.smith@example.com', 'password456', 'ADMIN'),
    ('michael.tan@example.com', 'password789', 'USER'),
    ('emily.green@example.com', 'password012', 'USER'),
    ('chris.brown@example.com', 'securepass789', 'USER');

INSERT INTO profiles (user_id, user_name, height, weight, age, gender, health_conditions)
VALUES
    (1,'johndoe',1.75, 70.5, 29, 'MALE', 'No known health conditions'),
    (2,'janesmith',1.65, 60.0, 32, 'FEMALE', 'Asthma'),
    (3,'michaeltan',1.80, 85.0, 35, 'MALE', 'Hypertension'),
    (4,'emilygreen',1.70, 55.0, 28, 'FEMALE', 'Diabetes'),
    (5,'chrisbrown',1.82, 90.0, 40, 'MALE', 'No known health conditions');
...
VALUES
    ...
    ('2024-09-18 19:00:00', 1.5, 'Completed meditation session for stress relief plan', 5);
